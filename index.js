...
artists.splice(8, 1, {...artists[8], name: "Vincent Van Gogh"});
...
function get20s(array) {
  ...
  for(let i = 0; i < array.length; i++){
    if(array[i].years.split('-') > 1899 && array[i].years.split('-') < 2000){
      obituary.push(array[i].name);
    }
  }
  return obituary;
}
...
console.log(addArtist(artists, 20, 'Irvin Arevalos', '1993 - current day', 'Web Design', 'Hispanic', 'Taking coding little by little'));
